...
import { CreateAdressInput, Genders, InputMaybe, Scalars } from "../graphql/generated";
...
interface FM extends InFormDataTypes<string, string> {
    ...
    // Complex Types
    ["CreateAdressInput"]: InFormDataTypeWithDefaultValueAndComponent<"CreateAdressInput", InputMaybe<CreateAdressInput>, { street: "S", number: 12 }, typeof FakeComp2>
