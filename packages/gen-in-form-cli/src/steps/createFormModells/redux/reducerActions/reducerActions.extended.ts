...
import { CREATE_FORM_MODELLS_ACTIONS_EXTENDED as extendedActions } from "./../actions/actions.extended";

/**
 * You may add here extending reducer actions for this features reducer
 */
export type CreateFormModellsReducerActionsExtended = {
...
export const isCreateFormModellsReducerActionsExtended = (
    item: any
): item is CreateFormModellsReducerActionsExtended => {
    if (!item) {
        return false;
    }
...
export default CreateFormModellsReducerActionsExtended;
