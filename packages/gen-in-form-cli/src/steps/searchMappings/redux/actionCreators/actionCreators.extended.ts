...
import { SearchMappingsReducerActionsExtended } from "./../reducerActions/reducerActions.extended";
// import { SEARCH_MAPPINGS_ACTIONS_EXTENDED } from "./../actions/actions.extended";

/**
 * You may add here extending actionCreators for this features reducer
 * actionCreator: ([params]): ExtenedReducerAction => (
 * {
 *   type: SEARCH_MAPPINGS_ACTIONS_EXTENDED["[actionName]"],
 *   [payload]
 * }),
 */
const extendedActionCreators = {
    ...
    //    return {
    //        type: SEARCH_MAPPINGS_ACTIONS_EXTENDED.ADD_LOADING_HANDLE,
    //        handle: handleToAdd
    //        };
    //    },
};
...
type ActionCreator = {
    [key in string]: (...params: any[]) => SearchMappingsReducerActionsExtended;
};
...
export const searchMappingsActionCreatorsExtended = checkActionCreator(
    extendedActionCreators
);

export default searchMappingsActionCreatorsExtended;
