...
import { SearchGeneralSettingsReducerActionsExtended } from "./../reducerActions/reducerActions.extended";
// import { SEARCH_GENERAL_SETTINGS_ACTIONS_EXTENDED } from "./../actions/actions.extended";

/**
 * You may add here extending actionCreators for this features reducer
 * actionCreator: ([params]): ExtenedReducerAction => (
 * {
 *   type: SEARCH_GENERAL_SETTINGS_ACTIONS_EXTENDED["[actionName]"],
 *   [payload]
 * }),
 */
const extendedActionCreators = {
    ...
    //    return {
    //        type: SEARCH_GENERAL_SETTINGS_ACTIONS_EXTENDED.ADD_LOADING_HANDLE,
    //        handle: handleToAdd
    //        };
    //    },
};
...
type ActionCreator = {
    [key in string]: (
        ...params: any[]
    ) => SearchGeneralSettingsReducerActionsExtended;
};
...
export const searchGeneralSettingsActionCreatorsExtended = checkActionCreator(
    extendedActionCreators
);

export default searchGeneralSettingsActionCreatorsExtended;
